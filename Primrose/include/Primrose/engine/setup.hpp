...
namespace Primrose {
	...
	extern vk::PipelineLayout pipelineLayout; // graphics pipeline layout

	extern vk::Pipeline marchPipeline; // graphics pipeline
	...
	vk::Pipeline createPipeline(vk::ShaderModule vertModule, vk::ShaderModule fragModule,
