...
//	}
	...
	bool onPlanet = glm::distance(playerPos, planetPos)-2.01 <= r;
...
//		);
	...
	{
		// planet
		glm::vec3 down = glm::normalize(planetPos - playerPos);
		float dist = glm::distance(playerPos, planetPos);
